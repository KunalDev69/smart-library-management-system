    ...
    <div className="flex min-h-screen pt-16">
      ...
      <div className="flex-1 p-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <h1 className="font-heading text-2xl font-bold text-gray-900 dark:text-white">Manage Books</h1>
          <button
            onClick={handleAdd}
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full">
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-white/5">
                {books.map((book) => (
                  <tr key={book._id} className="hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        {book.coverImage ? (
                          <img src={book.coverImage} alt={book.title} loading="lazy" className="w-10 h-12 object-cover rounded" />
                        ) : (
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{book.author}</td>
                    <td className="px-6 py-4">
