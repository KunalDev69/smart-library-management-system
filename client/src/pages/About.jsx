      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-4 rounded-full bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 backdrop-blur-sm">
            ...
            <span className="text-sm text-gray-600 dark:text-gray-300 font-medium">About the Project</span>
          </div>
          <h1 className="font-heading text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-5">
          ...
          <div className="glass-card p-10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center gap-2 mb-6">
                ...
                <h2 className="font-heading text-2xl font-bold text-gray-900 dark:text-white">Technology Stack</h2>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                {techStack.map((tech) => (
                  <div key={tech.name} className="bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl p-4 text-center hover:bg-gray-200 dark:hover:bg-white/10 transition-all">
                    <div className="text-lg font-bold text-gray-900 dark:text-white">{tech.name}</div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {extraTech.map((tech) => (
                  <div key={tech} className="bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl p-4 text-center hover:bg-gray-200 dark:hover:bg-white/10 transition-all">
                    <div className="text-sm font-medium text-gray-600 dark:text-gray-300">{tech}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <FadeIn className="mb-16">
          <div className="text-center mb-8">
            ...
            <h2 className="font-heading text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Key Features</h2>
          </div>
            ...
            {features.map((feature, index) => (
              <FadeIn key={index} delay={index * 0.1}>
                ...
                >
                  ...
                  <h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2">{feature.title}</h3>
        ...
        <FadeIn>
          <div className="glass-card p-10 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="font-heading text-2xl font-bold text-gray-900 dark:text-white mb-8">Project Team</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-lg mx-auto">
                {[
                  ...
                  <motion.div
                    key={member.name}
                    whileHover={{ y: -4 }}
                    className="bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl p-6"
                  >
